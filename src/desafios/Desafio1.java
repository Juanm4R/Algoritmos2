...
public class Desafio1 {
    public static boolean desafio1(ColaTDA origen) {
        ColaTDA copiaIdentica = new Estrategia_2_Cola(); copiaIdentica.InicializarCola();
        PilaTDA copiaInvertida = new PilaDinamica(); copiaInvertida.InicializarPila();
        ColaTDA aux = new Estrategia_2_Cola(); aux.InicializarCola();
